...
#define MAP_LITTLEROOT_TOWN_NEW_PROFESSOR_BIRCHS_LAB             (5 | (1 << 8))
#define MAP_LITTLEROOT_TOWN_NEW_PROFESSOR_BIRCHS_LAB_SECRET_ROOM (6 | (1 << 8))
...
#define MAP_LITTLEROOT_FOREST                        (108 | (24 << 8))
