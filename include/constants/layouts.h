...
#define LAYOUT_LITTLEROOT_TOWN_NEW_PROFESSOR_BIRCHS_LAB 442
#define LAYOUT_LITTLEROOT_TOWN_NEW_PROFESSOR_BIRCHS_LAB_SECRET_ROOM 443
#define LAYOUT_LITTLEROOT_FOREST 444
